<template>
  <section class="fe-page">
    ...
    <el-row class="fe-page">
      <el-col v-show="showEditor" :span="10" style="height: 100%;">
        ...
        <div class="ace—editor" ref="aceDiv"></div>
      </el-col>
      <el-col :span="span" style="height: 100%;">
        ...
        ></iframe>
        <!--带src-->
        <!-- <iframe ref="iframe" style="width: 100%;height:100%;border:0;" unselectable="on" src="/api_plan/canvas-test/menu.html"></iframe> -->
      </el-col>
    </el-row>
  </section>
</template>
...
export default {
  ...
  methods: {
    initEditor() {
      this.aceEditor = ace.edit(this.$refs.aceDiv, {
    ...
    openShowEditor() {
      ...
      this.codeBtnIcon =
        this.showEditor === true ? "el-icon-open" : "el-icon-turn-off";
      this.codeBtn = this.showEditor === true ? "收缩" : "源码";
